...
def build_app_state(settings: Settings) -> AppState:
    ...
    next_gw_rows = build_fixture_aware_next_gameweek_rows(
        engineered_data,
        player_id_columns=(
            settings.feature_engineering.player_id_columns
        ),
        chronological_columns=(
            settings.feature_engineering.chronological_columns
        ),
        max_valid_gameweek=(
            settings.prediction.max_valid_gameweek
        ),
...
def _build_current_fpl_prediction_pool(
    ...
    if join_col and not predictions.empty:
        ...
        # Build lookup dictionary from predictions.
        pred_lookup = (
            pred_subset
            .set_index(join_col)
