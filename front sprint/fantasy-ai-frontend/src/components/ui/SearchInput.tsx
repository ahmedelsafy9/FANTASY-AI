  ...
  return (
    <div className="group relative">
      ...
      <input
        ...
        className="w-full rounded-xl border border-border-soft bg-surface py-2.5 pl-10 pr-16 text-sm text-ink placeholder:text-ink-tertiary transition-colors focus:border-signal/50 focus:outline-none"
      />
      {value ? (
        <button
          onClick={() => onChange("")}
